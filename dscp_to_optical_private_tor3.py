...
ofdpa_instance = ofdpa.OFDPA(mode="ODL", controller_ip="10.10.10.254", ofdpa_id="openflow:55932", flow_start=100)
...
dummy_vlan = 10
dscp = 63
# Route traffic with dscp=60 and eth_dst=node_3_mac to node 3
