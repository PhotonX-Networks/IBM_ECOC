...
dummy_vlan = 10
usecase.one_way_bridge(ofdpa_instance, dummy_vlan, tor_3_ethernet_2_port, (ethernet_1_mac, tor_2_tor_3_port))
usecase.one_way_bridge(ofdpa_instance, dummy_vlan, tor_2_tor_3_port, (ethernet_2_mac, tor_3_ethernet_2_port))

usecase.one_way_bridge(ofdpa_instance, dummy_vlan, tor_2_tor_3_port, (node_3_mac, tor_3_node_3_port))
usecase.one_way_bridge(ofdpa_instance, dummy_vlan, tor_3_node_3_port, (node_1_mac, tor_2_tor_3_port))
