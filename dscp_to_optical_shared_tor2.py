...
ofdpa_instance = ofdpa.OFDPA(mode="ODL", controller_ip="10.10.10.254", ofdpa_id="openflow:55931", flow_start=200)
...
dummy_vlan = 10
dscp = 63
# We assume traffic from compute node 2 and TOR1 is allowed
