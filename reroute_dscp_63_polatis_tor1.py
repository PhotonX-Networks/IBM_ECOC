...
# Allow traffic coming from port tor_1_polatis
ofdpa.VLAN_VLAN_Filtering_Flow(ofdpa_instance, tor_1_polatis, dummy_vlan)
ofdpa.VLAN_Untagged_Packet_Port_VLAN_Assignment_Flow(ofdpa_instance,
                                                         tor_1_polatis,
                                                         dummy_vlan)

# Route traffic with dscp=63 and eth_dst=node_3_mac to tor_1_polatis
dscp = 63
...
# Route traffic with dscp=63 and eth_dst=node_1_mac to node_1_tor_1_port
l2_Interface_group = ofdpa.L2_Interface_Group(ofdpa_instance,
                                              node_1_tor_1_port,
                                              dummy_vlan,
                                              pop_vlan=True)
